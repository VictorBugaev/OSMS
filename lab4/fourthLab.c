...
int main() {
    ...
    int register_state_x[LENGTH] = {0, 0, 0, 1, 1};
    int register_state_y[LENGTH] = {0, 1, 0, 1, 0};

    int register_state_x1[LENGTH] = {0, 0, 1, 0, 0};
    int register_state_y1[LENGTH] = {0, 0, 1, 0, 1};
    ...
    for (int shift = 0; shift < cons+1; shift++) {
        printf("%5d|", shift);
